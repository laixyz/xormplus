...
type MigrateFunc func(*xormplus.Engine) error

// RollbackFunc is the func signature for rollbacking.
type RollbackFunc func(*xormplus.Engine) error

// InitSchemaFunc is the func signature for initializing the schemas.
type InitSchemaFunc func(*xormplus.Engine) error
...
func New(db *xormplus.Engine, options *Options, migrations []*Migration) *Migrate {
	return &Migrate{
		db:         db,
		options:    options,
