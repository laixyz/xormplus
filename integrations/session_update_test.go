...
import (
	...
	"github.com/laixyz/xormplus/internal/statements"
	"github.com/laixyz/xormplus/internal/utils"
...
func setupForUpdate(engine xormplus.EngineInterface) error {
	v := new(ForUpdate)
...
func TestWhereCondErrorWhenUpdate(t *testing.T) {
	...
	assert.Error(t, err)
	assert.EqualValues(t, xormplus.ErrConditionType, err)
}
