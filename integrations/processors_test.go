...
func (p *ProcessorsStruct) BeforeSet(col string, cell xormplus.Cell) {
...
func (p *ProcessorsStruct) AfterSet(col string, cell xormplus.Cell) {
...
func (s *AfterLoadStructB) AfterLoad(session *xormplus.Session) {
